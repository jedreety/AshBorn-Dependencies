/**
 * Loader generated by glad 2.0.8 on Sun Aug  3 23:03:47 2025
 *
 ...
 *
 * Commandline:
 *    --api='vulkan=1.4' --extensions='VK_AMD_buffer_marker,VK_AMD_draw_indirect_count,VK_AMD_memory_overallocation_behavior,VK_AMD_shader_info,VK_EXT_astc_decode_mode,VK_EXT_attachment_feedback_loop_layout,VK_EXT_buffer_device_address,VK_EXT_calibrated_timestamps,VK_EXT_conditional_rendering,VK_EXT_conservative_rasterization,VK_EXT_debug_utils,VK_EXT_depth_clamp_control,VK_EXT_descriptor_buffer,VK_EXT_descriptor_indexing,VK_EXT_extended_dynamic_state,VK_EXT_extended_dynamic_state2,VK_EXT_extended_dynamic_state3,VK_EXT_fragment_shader_interlock,VK_EXT_full_screen_exclusive,VK_EXT_graphics_pipeline_library,VK_EXT_hdr_metadata,VK_EXT_host_image_copy,VK_EXT_host_query_reset,VK_EXT_image_compression_control,VK_EXT_image_view_min_lod,VK_EXT_inline_uniform_block,VK_EXT_line_rasterization,VK_EXT_memory_budget,VK_EXT_memory_priority,VK_EXT_mesh_shader,VK_EXT_multisampled_render_to_single_sampled,VK_EXT_mutable_descriptor_type,VK_EXT_non_seamless_cube_map,VK_EXT_pageable_device_local_memory,VK_EXT_private_data,VK_EXT_rasterization_order_attachment_access,VK_EXT_sample_locations,VK_EXT_shader_module_identifier,VK_EXT_shader_object,VK_EXT_shader_subgroup_ballot,VK_EXT_shader_subgroup_vote,VK_EXT_swapchain_colorspace,VK_EXT_texture_compression_astc_hdr,VK_EXT_tooling_info,VK_EXT_transform_feedback,VK_EXT_validation_features,VK_EXT_vertex_input_dynamic_state,VK_EXT_ycbcr_2plane_444_formats,VK_IMG_format_pvrtc,VK_INTEL_performance_query,VK_KHR_16bit_storage,VK_KHR_8bit_storage,VK_KHR_acceleration_structure,VK_KHR_bind_memory2,VK_KHR_buffer_device_address,VK_KHR_copy_commands2,VK_KHR_create_renderpass2,VK_KHR_dedicated_allocation,VK_KHR_depth_stencil_resolve,VK_KHR_descriptor_update_template,VK_KHR_device_group,VK_KHR_device_group_creation,VK_KHR_draw_indirect_count,VK_KHR_dynamic_rendering,VK_KHR_dynamic_rendering_local_read,VK_KHR_external_fence,VK_KHR_external_fence_capabilities,VK_KHR_external_memory,VK_KHR_external_memory_capabilities,VK_KHR_external_semaphore,VK_KHR_external_semaphore_capabilities,VK_KHR_format_feature_flags2,VK_KHR_get_memory_requirements2,VK_KHR_get_physical_device_properties2,VK_KHR_line_rasterization,VK_KHR_maintenance1,VK_KHR_maintenance3,VK_KHR_maintenance4,VK_KHR_maintenance5,VK_KHR_maintenance6,VK_KHR_map_memory2,VK_KHR_multiview,VK_KHR_performance_query,VK_KHR_pipeline_library,VK_KHR_present_id,VK_KHR_present_wait,VK_KHR_push_descriptor,VK_KHR_ray_query,VK_KHR_ray_tracing_maintenance1,VK_KHR_ray_tracing_pipeline,VK_KHR_ray_tracing_position_fetch,VK_KHR_sampler_mirror_clamp_to_edge,VK_KHR_sampler_ycbcr_conversion,VK_KHR_shader_atomic_int64,VK_KHR_shader_clock,VK_KHR_shader_draw_parameters,VK_KHR_shader_float16_int8,VK_KHR_shader_non_semantic_info,VK_KHR_shader_subgroup_extended_types,VK_KHR_surface,VK_KHR_swapchain,VK_KHR_synchronization2,VK_KHR_timeline_semaphore,VK_KHR_wayland_surface,VK_KHR_win32_keyed_mutex,VK_KHR_win32_surface,VK_KHR_workgroup_memory_explicit_layout,VK_KHR_xcb_surface,VK_KHR_xlib_surface,VK_NV_device_diagnostic_checkpoints,VK_NV_device_diagnostics_config,VK_NV_mesh_shader,VK_NV_ray_tracing,VK_NV_representative_fragment_test' c --alias --loader --mx
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.4&generator=c&options=ALIAS%2CLOADER%2CMX
 *
 */
...
typedef struct GladVulkanContext {
    ...
    int KHR_dynamic_rendering_local_read;
